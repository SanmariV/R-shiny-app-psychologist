...
# merge two tibbles
combination <- inner_join(mean_sessions_per_age_f, mean_sessions_per_age_m) %>%                 glimpse()
...
avg_sessions_female <- mean_sessions_per_age_f %>% 
                filter(age >= 14 & age < 67) %>% 
                view()

avg_sessions_male <- mean_sessions_per_age_m %>% 
                filter(age >= 14 & age < 67) %>% 
                view()
```
